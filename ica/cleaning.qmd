...
# 1.
library(tidyverse)
sf_weather <- read_csv("~/Course Work/stat212/repos/ds212-portfolio-alamb378/ica/data/raw/weather.csv")
view(sf_weather)

#2. 
sf_weather_clean <- sf_weather |> 
...
write_csv(sf_weather_clean,file="~/Course Work/stat212/repos/ds212-portfolio-alamb378/ica/data/raw/weather.csv")
```
