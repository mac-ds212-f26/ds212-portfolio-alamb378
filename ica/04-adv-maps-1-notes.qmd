...
mn_cities <- st_read("~/Course Work/stat212/repos/ds212-portfolio-alamb378/ica/04_adv_maps/data/City_And_Township_Population_Centers/City_And_Township_Population_Centers.shp")

mn_water <- st_read("~/Course Work/stat212/repos/ds212-portfolio-alamb378/ica/04_adv_maps/data/Lakes_and_Rivers/Lakes_and_Rivers.shp")
```
...
```{r transform_nc}
# Transformed the expression of the spatial object 
...
transform_and_plot <- function(nc, new_crs) {
    nc |> 
...
transform_and_plot(nc, new_crs = "EPSG:22293")
...
png("~/Course Work/stat212/repos/ds212-portfolio-alamb378/ica/04_adv_maps/figure/tc_map_zoom.png", width = 1000, height = 1000)
ggplot() +
    geom_raster(data = elev_df, aes(x = x, y = y, fill = elevation)) + 
    geom_sf(data = mn_counties, fill = NA, color = "black") + # county boundary layer
    geom_sf(data = mn_water, fill = "lightsteelblue1", color = "lightsteelblue1") + # NEW: river/lake layer
